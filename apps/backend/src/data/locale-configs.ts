...
/** English language names for AI translation prompts */
...
/** Set of all valid locale codes for fast validation */
export const VALID_LOCALE_CODES = new Set(
  ALL_LOCALE_CONFIGS.map((config) => config.code)
);
