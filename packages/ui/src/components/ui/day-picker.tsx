...
import { buttonVariants } from "@avo/ui/components/ui/button";
  ...
  return (
    <ReactDayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative flex size-9 items-center justify-center p-0 text-center text-sm text-t-secondary focus-within:relative focus-within:z-20",
