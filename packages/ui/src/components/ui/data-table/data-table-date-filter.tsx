/** biome-ignore-all lint/nursery/noUselessUndefined: <ok> */
"use client";

import { Button } from "@avo/ui/components/ui/button";
import { Calendar } from "@avo/ui/components/ui/calendar";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
...
import { formatDate } from "@avo/ui/lib/format";
...
function renderDateFilterLabel(params: {
  multiple?: boolean;
  selectedDates: DateSelection;
  title?: string;
  formatDateRange: (range: DateRange) => string;
}): ReactNode {
  const { multiple, selectedDates, title, formatDateRange } = params;
  ...
  if (multiple) {
    ...
    const hasSelectedDates = Boolean(selectedDates.from || selectedDates.to);
